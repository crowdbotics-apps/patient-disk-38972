"""
Django settings for patient_disk_38972 project.
...
ROOT_URLCONF = 'patient_disk_38972.urls'
...
WSGI_APPLICATION = 'patient_disk_38972.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_disk_38972 API",
    "DESCRIPTION": "API documentation for patient_disk_38972 App",
    "VERSION": "v1",
}
